...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow hover:bg-primary/90 disabled:bg-gray-300 disabled:text-gray-500",
...
const PromptInput = React.forwardRef<HTMLDivElement, PromptInputProps>(
  ({ placeholder = "Skriv din melding...", onSubmit, onChange, onFileUpload, disabled = false, className }, ref) => {
    ...
    return (
      ...
      >
        ...
        >
          <Paperclip size={16} />
          <span className="sr-only">Last opp fil</span>
        </Button>
...
export { Button, PromptInput, buttonVariants }
