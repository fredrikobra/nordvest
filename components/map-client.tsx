...
export default function MapClient() {
  ...
  return (
    <div className="relative h-[450px] md:h-[500px] w-full rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden bg-slate-50 dark:bg-slate-900">
      <iframe
